...
// Smart revenue formatting with microunits detection
...
/**
 * Heuristic: if value >= 1e13, it's very likely microunits (×1e6).
 * (Individual quarterly revenues > $10T don't make sense.)
 */
const normalizeUSD = (n: number): number => (n >= 1e13 ? n / 1_000_000 : n);

/**
 * Smart revenue formatting with automatic microunits detection
 * @param value - Revenue value (may be in microunits)
