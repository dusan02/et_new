  ...
  async upsert(data: CreateMarketDataInput): Promise<MarketData> {
    return await prisma.todayEarningsMovements.upsert({
      ...
      update: {
        ...
        marketCapDiff: data.marketCapDiff || undefined,
        marketCapDiffBillions: data.marketCapDiffBillions || undefined,
        priceChangePercent: data.priceChangePercent || undefined,
